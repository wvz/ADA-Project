...
save(R.Q, R.A, R.Tags, file = "~/Google Drive/Columbia/5291 ADA/1202 Project/Workspace.RData")

load("~/Google Drive/Columbia/5291 ADA/1202 Project/Workspace.RData")
head(R.Q)
...
mean(by(R.A$Id, R.A$ParentId, length)) # 1.59
...
text processing package: tidy_text_r package
